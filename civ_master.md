{
  ...
  "version": "1.2",
  "description": "Master JSON compiled from all civilization decks including Belief Systems. Extended with brain-core civilizational field framework.",
  "included_decks": [
    "Mesopotamia",
    "Ancient Egypt",
    "Rome",
  ...
  "decks": [
    {
      ...
      "teacher": {
        ...
        "brain_reference": {
          "law": "Directed energy becomes stored order. Stored order becomes civilization. Civilization reshapes future reality.",
          "application": "Leaders direct energy, systems organize it, structures store it, and events release or redirect it."
        }
      },
      "cards": {
        "leaders": [
          {
            ...
            "field_model": {
              "energy_input": "unassigned",
              "coherence_factor": "unassigned",
              "structure_output": "unassigned",
              "connectivity_effect": "unassigned",
              "entropy_risk": "unassigned"
            }
          },
          {
    ...
    },
    {
      ...
      "cards": {
        "leaders": [
          ...
          {
            "id": "belief_leader_prophet_muhammed",
          ...
          {
            "id": "belief_leader_siddhartha_gautama",
  ...
  "brain_core": {
    "primary_architecture": "INPUT → PATTERN → CONTEXT → EVALUATION → DECISION → ACTION",
    "governing_law": {
      "name": "Civilization Energy Principle",
      "statement": "Directed energy, when organized through coherence, becomes durable structure. Durable structure increases connectivity. Connectivity reshapes future civilization states."
    },
    ...
    "civilization_loop": "ENERGY → COHERENCE → STRUCTURE → CONNECTIVITY → FUTURE STATE",
    "decision_rule": [
      "Does this input create order?",
      "Does it create strain?",
      "Does it strengthen structure?",
      "Does it alter connectivity?",
      "Does it destabilize existing systems?"
    ],
    "collapse_law": "When structure no longer supports energy demand, connectivity destabilizes and fragmentation begins.",
    "final_law": "Directed energy becomes stored order. Stored order becomes civilization. Civilization reshapes future reality."
  },
  "framework_schema": {
    "field_model_schema": {
      "energy_input": "unassigned",
    ...
    "interpretive_lens": [
      "What energy created this?",
      "What system organized it?",
      "What structure stored it?",
      "What connections did it produce?",
      "What stress could dissolve it?"
    ],
    "civilization_master_model": "Leaders direct energy, systems organize energy, structures store energy, events release or redirect energy."
  }
}